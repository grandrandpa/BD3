...
class CShowJalView : public CHWATestView
{
	DECLARE_DYNCREATE(CShowJalView)

public:
	CShowJalView();           // protected constructor used by dynamic creation
	virtual ~CShowJalView();
